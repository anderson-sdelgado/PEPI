...
public class AtualizarAplicativo extends AsyncTask<String ,Integer ,Boolean> {
    ...
    protected Boolean doInBackground(String... arg0) {
        ...
        try {
            ...
            URL url = new URL("http://www.usinasantafe.com.br/pepi/pepi.apk");
            ...
            File outputFile = new File(file,"pepi.apk");
    ...
    void OpenNewVersion(String location) {
        ...
        intent.setDataAndType(Uri.fromFile(new File(location + "pepi.apk")),
